...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """freelancelot""", """controllers.HomeController.freelance"""),
    Nil
  ...
  // @LINE:9
  private[this] lazy val controllers_HomeController_sayHello3_route = Route("GET",
  ...
  // @LINE:12
  private[this] lazy val controllers_HomeController_freelance5_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("freelancelot")))
  )
  private[this] lazy val controllers_HomeController_freelance5_invoker = createInvoker(
    HomeController_0.freelance,
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "freelance",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    case controllers_HomeController_sayHello3_route(params@_) =>
      call(params.fromPath[String]("name", None)) { (name) =>
        controllers_HomeController_sayHello3_invoker.call(HomeController_0.sayHello(name))
      }
    ...
    // @LINE:12
    case controllers_HomeController_freelance5_route(params@_) =>
      call { 
        controllers_HomeController_freelance5_invoker.call(HomeController_0.freelance)
      }
  }
}
