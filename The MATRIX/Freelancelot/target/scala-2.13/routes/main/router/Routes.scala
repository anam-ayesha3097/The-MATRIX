...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix, """controllers.HomeController.freelancer(searchTerm:String ?= "")"""),
  ...
  // @LINE:14
  private[this] lazy val controllers_HomeController_freelancer5_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix)))
  )
  private[this] lazy val controllers_HomeController_freelancer5_invoker = createInvoker(
    HomeController_1.freelancer(fakeValue[String]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
  ...
  private[this] lazy val controllers_HomeController_ownerInformation6_invoker = createInvoker(
    HomeController_1.ownerInformation(fakeValue[String]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "ownerInformation",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:14
    case controllers_HomeController_freelancer5_route(params@_) =>
      call(params.fromQuery[String]("searchTerm", Some(""))) { (searchTerm) =>
        controllers_HomeController_freelancer5_invoker.call(HomeController_1.freelancer(searchTerm))
      }
  
    // @LINE:15
    case controllers_HomeController_ownerInformation6_route(params@_) =>
      call(params.fromPath[String]("ownerId", None)) { (ownerId) =>
        controllers_HomeController_ownerInformation6_invoker.call(HomeController_1.ownerInformation(ownerId))
      }
  }
}
