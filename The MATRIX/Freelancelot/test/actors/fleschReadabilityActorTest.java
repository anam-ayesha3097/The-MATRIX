...
/**
 * Actor Test Class for FleschReadability Index
 * @author Anam Ayesha Shaikh
 */
@RunWith(MockitoJUnitRunner.Silent.class)
public class fleschReadabilityActorTest  {
    @ClassRule
        ...
        new TestKit(system) {
            {
                ...
                Props props = Props.create(FleschReadabilityIndexActor.class);
                Object results = new Object();
                TestActorRef<FleschReadabilityIndexActor> ref = TestActorRef.create(system,props);
