...
public class skills {
    ...
    public static HashMap<String, FreelaancelotList> getDataSkills(String searchTerm ){
        ...
        try {
            ...
            if (conn.getResponseCode() == 200) {
                ...
                for(int i = 0; i < jsonArr.length(); i++){
                    ...
                    skills = skillarr[0];
                    proj_det = new Freelancelot(owner_ID, converted_date,project_ID, project_title, project_Description, project_type, skills, "", 1L,"");
